                    ...
                    <div className="space-y-8">
                        ...
                        {chapters.filter(c => c.status === 'completed').length === 0 ? (
                            <div className="card text-center py-12">
                                ...
                                <h3 className="text-lg font-semibold mb-2">No Completed Chapters</h3>
                                <p className="text-surface-400 text-sm mb-4 max-w-sm mx-auto">
                                    Finish writing chapters in the Editor tab to see them appear here in your manuscript.
                                </p>
                                <button onClick={() => setActiveTab('editor')} className="btn-primary text-sm">
                                    Go to Editor
                                </button>
                            </div>
                        ) : (
